...
async function doPost(content, service, profile) {
  ...
  const post = await saveEntityRecord('postType', 'post', {
    title,
    content,
    status: 'publish'
  });
  ...
  const updatedPost = await saveEntityRecord('postType', 'post', {
    id: post.id,
    content: contentWithSkeetLink
  });
  const ret = {
    post: updatedPost,
    skeet: {
...
const PoastList = _ref2 => {
  let {
    links
  } = _ref2;
  if (!links.length) {
    return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", null, "No new Posts");
  }
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("h4", null, "Links Poasted:"), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("ul", null, links.map((_ref3, index) => {
    let {
      url,
      text
    } = _ref3;
...
const WPoaster = () => {
  ...
  const sendPost = async text => {
    const {
      post,
      skeet
    } = await doPost(text, service, profile);
    const newLinks = [];
    newLinks.push({
      url: post.link,
      text: 'Local Post'
  ...
  }), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(BskyProfile, {
    service: service,
    profile: profile
  ...
  }, "WPoast It!"), ' ' + text.length, " / ", limit, " chars", (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(PoastList, {
    links: links
  }));
};
